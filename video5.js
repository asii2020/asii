...
function redirectAndStartTimer() {
    ...
    window.location.href = 'https://www.cpmrevenuegate.com/scni3irs2?key=6b6a077fe4b25c1249aeaec51ea1f762';
}
...
document.getElementById("greenButton").addEventListener("click", () => {
    ...
    if (!redButtonClicked) {
        ...
        window.location.href = 'https://hotslfun.blogspot.com/2024/09/ex-girlfriend.html';
    }
});
